...
export default function AdminCopyDashboard() {
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-200 p-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-blue-900">Admin Copy Dashboard</h2>
              <p className="text-sm text-blue-700">Viewing content from member perspective</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-8">
          ...
          {/* Content grid with same layout as regular dashboard */}
                    ...
                    <div key={volunteer.id} className="p-4 bg-transparent border border-border rounded-xl hover:shadow-gentle transition-all duration-200 group">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" className="rounded-full h-6 px-3 text-xs group-hover:bg-accent group-hover:text-white" asChild>
                          <Link to="/admin-copy/volunteering">
                            View <ChevronRight className="w-3 h-3 ml-1" />
                          </Link>
                        </Button>
                      </div>
              ...
              <CardContent className="space-y-6 flex-1">
                ...
                <div className="pt-4 border-t border-border">
                  <Button variant="outline" className="w-full rounded-xl text-sm">
                    View All Achievements <Award className="w-4 h-4 ml-2" />
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Bottom Section: Community Activity & Recent Activity */}
              ...
              <CardContent className="space-y-4">
                {communityNeeds.slice(0, 3).map((need) => (
                  <div key={need.id} className="p-4 bg-transparent border border-border rounded-xl hover:shadow-gentle transition-all duration-200 group">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h3 className="font-semibold text-foreground text-sm mb-1">{need.title}</h3>
                        <p className="text-xs text-muted-foreground mb-2">{need.description}</p>
                      </div>
                      <Badge 
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="ghost" size="sm" className="rounded-full h-6 px-3 text-xs group-hover:bg-primary group-hover:text-white">
                        Help Out <ChevronRight className="w-3 h-3 ml-1" />
                      </Button>
                    </div>
                  </div>
                ))}
                <Button variant="outline" className="w-full rounded-xl text-sm mt-4" asChild>
                  <Link to="/admin-copy/browse">
                    Browse All Needs <ChevronRight className="w-4 h-4 ml-2" />
                  </Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-card bg-card hover:shadow-gentle transition-all duration-300 rounded-2xl">
              ...
              <CardContent className="space-y-4">
                {recentActivity.map((activity) => {
                  ...
                  return (
                    <div key={activity.id} className="flex items-start gap-4 p-4 bg-transparent border border-border rounded-xl hover:shadow-gentle transition-all duration-200">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-foreground text-sm mb-1">{activity.title}</h3>
                ...
                <Button variant="outline" className="w-full rounded-xl text-sm mt-4">
