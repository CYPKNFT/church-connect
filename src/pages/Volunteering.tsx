...
export default function Volunteering() {
  ...
  useEffect(() => {
    document.title = "My Volunteering | ChurchConnect";
  }, []);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <Card className="border-0 shadow-card bg-gradient-to-br from-emerald-50 to-green-100">
        ...
        <div className="space-y-4">
          {filteredVolunteering.length === 0 ? (
            ...
            filteredVolunteering.map((volunteer) => (
              <Card key={volunteer.id} className="border-0 shadow-card bg-white hover:shadow-gentle transition-all duration-300 rounded-2xl">
                <CardContent className="p-6">
