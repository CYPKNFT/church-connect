      ...
      <div className="p-6 lg:p-8">
        <header className="mb-6">
          ...
          <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <button className="group relative flex items-center justify-between rounded-2xl bg-gradient-to-r from-warning to-warning/80 px-4 py-4 font-semibold text-warning-foreground shadow-lg transition hover:brightness-110">
            ...
            <button className="group relative flex items-center justify-between rounded-2xl bg-gradient-to-r from-primary to-primary/80 px-4 py-4 font-semibold text-primary-foreground shadow-lg transition hover:brightness-110">
              <span className="flex items-center gap-2">
