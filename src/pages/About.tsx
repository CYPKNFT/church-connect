    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-24">
        ...
        <section className="mb-32 animate-fade-in">
          <div className="relative bg-card rounded-[3.5rem] p-16 lg:p-24 overflow-hidden border border-border">
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center gap-2 bg-muted/50 border border-border rounded-full px-6 py-3 text-muted-foreground font-medium mb-8">
                <Target className="w-5 h-5" />
                <span>Our Purpose</span>
              </div>
              <h2 className="text-5xl lg:text-6xl font-bold mb-12 text-accent">Our Mission</h2>
              <p className="text-2xl lg:text-3xl leading-relaxed max-w-5xl mx-auto text-muted-foreground">
                To create a transformative digital platform where church families can easily connect, 
        ...
        {/* Values Section */}
        <section className="mb-32 animate-slide-up relative overflow-hidden">
          {/* Background Elements - Full Width */}
          <div className="absolute inset-x-[-50vw] left-[50%] translate-x-[-50%] overflow-hidden pointer-events-none">
        ...
        <section className="mb-32 animate-scale-in">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="bg-[linear-gradient(135deg,#2563eb_0%,#059669_100%)] dark:bg-[linear-gradient(135deg,#2d1b69_0%,#8b4513_100%)] rounded-3xl p-16 relative overflow-hidden">
        ...
        {/* Impact Section */}
        <section className="mb-32 animate-fade-in">
          <div className="relative bg-[linear-gradient(135deg,#2563eb_0%,#059669_100%)] dark:bg-[linear-gradient(135deg,#2d1b69_0%,#8b4513_100%)] rounded-3xl p-16 lg:p-24 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-primary/10 dark:from-white/10 dark:to-secondary/5"></div>
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-20">
                <Card className="border-0 shadow-card bg-card/90 text-center p-12">
                  <CardContent>
                    <div className="text-6xl font-bold text-white mb-4">12,000+</div>
                    <h3 className="text-2xl font-semibold text-white mb-4">Needs Fulfilled</h3>
                ...
                <Card className="border-0 shadow-card bg-card/90 text-center p-12">
                  <CardContent>
                    ...
                    <h3 className="text-2xl font-semibold text-white mb-4">Church Partners</h3>
                    <p className="text-lg text-white/80">
                ...
                <Card className="border-0 shadow-card bg-card/90 text-center p-12">
                  <CardContent>
                    ...
                    <h3 className="text-2xl font-semibold text-white mb-4">Active Members</h3>
                    <p className="text-lg text-white/80">
