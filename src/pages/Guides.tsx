  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-20 bg-gradient-to-r from-white/10 to-secondary/5 rounded-2xl p-12 pb-16">
        ...
        <section className="mb-20 bg-gradient-to-l from-white/10 to-secondary/5 rounded-2xl p-12 pb-16">
          <div className="text-center mb-8">
        ...
        <section className="mb-16 bg-gradient-to-l from-white/10 to-secondary/5 rounded-2xl p-12 pb-16">
          <div className="text-center mb-8">
        ...
        <section className="mb-16 bg-gradient-to-r from-white/10 to-secondary/5 rounded-2xl p-12 pb-16">
          <div className="text-center mb-8">
