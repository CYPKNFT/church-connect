  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-20 bg-gradient-to-r from-gray-100 to-transparent rounded-2xl p-8">
        ...
        <section className="mb-20 bg-gradient-to-l from-gray-100 to-transparent rounded-2xl p-8">
          <div className="text-center mb-8">
        ...
        <section className="mb-16 bg-gradient-to-l from-gray-100 to-transparent rounded-2xl p-8">
          <div className="text-center mb-8">
        ...
        <section className="mb-16 bg-gradient-to-r from-gray-100 to-transparent rounded-2xl p-8">
          <div className="text-center mb-8">
