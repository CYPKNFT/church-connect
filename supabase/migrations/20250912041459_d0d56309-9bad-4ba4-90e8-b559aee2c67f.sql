...
-- Update existing functions with better style and verification checks
...
-- Now update the RLS policy with creator access
...
-- Handle existing data: Delete churches with NULL admin_user_id (if any)
-- These would be orphaned churches without owners
DELETE FROM public."Churches" WHERE admin_user_id IS NULL;
